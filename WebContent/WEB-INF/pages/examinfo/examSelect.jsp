...
<div class="pageHeader">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li class=""><a class="add" href="${ctx}/pages/examinfo/examAdd.do?pageNum=${pageBean.currentPage}" target="dialog" mask="true" title="新增考核"><span>添加</span></a></li>
	...
	<table id="test" class="form" width="100%" layoutH="90" targetType="navTab">
		...
		<tbody>
			...
			<%-- 	    <td>
			    ...
			    <td><a onclick="delStu('${exam.examId }')" class="f1">删除</a></td>
			  </tr>
			</c:forEach>
		</tbody>
	</table>
