			...
			<form onsubmit="return validateCallback(this, dialogAjaxDone);"
				...
				<div class="pageFormContent" layouth="56"
					...
					<p>
					 ...
					 -->
					<p>
						<label>性别:</label> <input type="radio" name="stuSex" value="1">男
						<input type="radio" name="stuSex" value="2">女
					</p>
					<p>
						<label>年龄:</label> <input type="text" size="10" name="stuAge"
							class="textInput number" onblur="checkAge(this);">
					</p>
					<p>
						<label>联系方式：</label><input type="text" name="stuTel">
					</p>
					<p>
						<label>学历:</label><input type="text" name="stuEdu">
					</p>
					<p>
						<label>专业:</label><input type="text" name="stuMaior">
					</p>
					<p>
						<label>毕业院校:</label><input type="text" name="stuGraduate">
					</p>
					<p>
						<label>家庭住址:</label><input type="text" name="stuAddress">
					</p>
					<p>
						<label>工作经验:</label><input type="text" name="stuExpe">
					</p>
					<p>
						<label>参加实训时间:</label><input type="text" name="stuTrainTime">
					</p>
					<p>
						<label>所属项目组:</label><input type="text" name="stuProjectNo">
					</p>
					<p>
						<label>迟到次数:</label><input type="text" name="lateCount">
					</p>
					<p>
